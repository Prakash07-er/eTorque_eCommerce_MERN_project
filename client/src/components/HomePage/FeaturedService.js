...
export default function Featuredservice() {
    return (
        ...
        <section id="featured-services" class="featured-services">
            ...
            <div class="container feature_heading" data-aos="fade-up"  data-aos-delay="100" >
                    <h1>We are the leading developer <br/> and installer of  <span class="modern"> modern electric </span><br/> vehicle charging systems</h1><br/>
                <div class="row">
                <div class="card-deck">
                    <div class="card feature_card" data-aos="fade-right"  data-aos-delay="100">
                        ...
                        <a href="#contact_us_form" class="btn btn-primary"> Get In Touch</a>
                        </div>
                    </div>
